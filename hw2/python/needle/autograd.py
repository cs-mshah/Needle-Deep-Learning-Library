...
import needle
from typing import List, Optional, NamedTuple, Tuple, Union, DefaultDict, Dict
...
def compute_gradient_of_variables(output_tensor, out_grad):
    ...
    for node in reverse_topo_order:
        # sum of gradients from upstream partial adjoints (v-bar-i)
        # save gradient from upstream partial adjoints for current node
